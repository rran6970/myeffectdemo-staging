...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'notifications_notification', 'notification_type',
                      self.gf('django.db.models.fields.CharField')(default='challenge_posted', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.notification_type'
        db.delete_column(u'notifications_notification', 'notification_type')
