...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserNotification.link'
        db.add_column(u'notifications_usernotification', 'link',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Notification.link'
        db.add_column(u'notifications_notification', 'link',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserNotification.link'
        db.delete_column(u'notifications_usernotification', 'link')

        # Deleting field 'Notification.link'
        db.delete_column(u'notifications_notification', 'link')
