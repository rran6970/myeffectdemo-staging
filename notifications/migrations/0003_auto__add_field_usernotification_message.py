...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserNotification.message'
        db.add_column(u'notifications_usernotification', 'message',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserNotification.message'
        db.delete_column(u'notifications_usernotification', 'message')
