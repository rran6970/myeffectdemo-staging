...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.from_privacy'
        db.add_column(u'userprofile_usersettings', 'from_privacy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.from_privacy'
        db.delete_column(u'userprofile_usersettings', 'from_privacy')
    ...
    models = {
        ...
        u'userprofile.usersettings': {
            ...
            'from_privacy': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
