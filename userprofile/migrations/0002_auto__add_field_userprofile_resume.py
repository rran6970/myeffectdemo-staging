...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.resume'
        db.add_column(u'userprofile_userprofile', 'resume',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.resume'
        db.delete_column(u'userprofile_userprofile', 'resume')
