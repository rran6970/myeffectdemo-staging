...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.referral_token'
        db.add_column(u'userprofile_userprofile', 'referral_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.referral_token'
        db.delete_column(u'userprofile_userprofile', 'referral_token')
