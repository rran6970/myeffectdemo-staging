...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.user'
        db.add_column(u'userprofile_usersettings', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.user'
        db.delete_column(u'userprofile_usersettings', 'user_id')
