...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.timezone'
        db.add_column(u'userprofile_usersettings', 'timezone',
                      self.gf('timezone_field.fields.TimeZoneField')(default='America/Toronto'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.timezone'
        db.delete_column(u'userprofile_usersettings', 'timezone')
