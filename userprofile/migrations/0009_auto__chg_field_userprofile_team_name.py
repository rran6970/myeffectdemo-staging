...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.team_name'
        db.alter_column(u'userprofile_userprofile', 'team_name', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.team_name'
        db.alter_column(u'userprofile_userprofile', 'team_name', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'team_name': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
