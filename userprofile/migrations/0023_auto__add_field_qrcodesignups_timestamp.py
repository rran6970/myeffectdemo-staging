...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QRCodeSignups.timestamp'
        db.add_column(u'userprofile_qrcodesignups', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QRCodeSignups.timestamp'
        db.delete_column(u'userprofile_qrcodesignups', 'timestamp')
