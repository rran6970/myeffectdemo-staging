...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserQRCode.data'
        db.alter_column(u'userprofile_userqrcode', 'data', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'UserQRCode.data'
        db.alter_column(u'userprofile_userqrcode', 'data', self.gf('django.db.models.fields.TextField')(null=True))
