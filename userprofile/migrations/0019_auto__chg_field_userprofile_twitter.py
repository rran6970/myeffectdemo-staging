...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'userprofile_userprofile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.twitter'
        db.alter_column(u'userprofile_userprofile', 'twitter', self.gf('django.db.models.fields.TextField')(null=True))
