...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.cleam_team'
        db.delete_column(u'userprofile_userprofile', 'cleam_team_id')

        # Adding field 'UserProfile.clean_team'
        db.add_column(u'userprofile_userprofile', 'clean_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.cleam_team'
        db.add_column(u'userprofile_userprofile', 'cleam_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], null=True),
                      keep_default=False)

        # Deleting field 'UserProfile.clean_team'
        db.delete_column(u'userprofile_userprofile', 'clean_team_id')
