...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.has_upgraded'
        db.add_column(u'userprofile_userprofile', 'has_upgraded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.has_upgraded'
        db.delete_column(u'userprofile_userprofile', 'has_upgraded')
