...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofile_userprofile', 'settings',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['userprofile.UserSettings'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'userprofile_userprofile', 'settings_id')
