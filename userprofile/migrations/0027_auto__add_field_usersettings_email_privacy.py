...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.email_privacy'
        db.add_column(u'userprofile_usersettings', 'email_privacy',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.email_privacy'
        db.delete_column(u'userprofile_usersettings', 'email_privacy')
    ...
    models = {
        ...
        u'userprofile.usersettings': {
            ...
            'email_privacy': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
