...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.emergency_contact_fname'
        db.add_column(u'userprofile_userprofile', 'emergency_contact_fname',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.emergency_contact_lname'
        db.add_column(u'userprofile_userprofile', 'emergency_contact_lname',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.emergency_contact_fname'
        db.delete_column(u'userprofile_userprofile', 'emergency_contact_fname')

        # Deleting field 'UserProfile.emergency_contact_lname'
        db.delete_column(u'userprofile_userprofile', 'emergency_contact_lname')
    ...
    models = {
        ...
        u'cleanteams.cleanteam': {
            ...
            'org_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['cleanteams.OrgProfile']", 'unique': 'True', 'null': 'True'}),
        ...
        u'userprofile.userprofile': {
            ...
            'google_plus': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            ...
            'linkedin': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
