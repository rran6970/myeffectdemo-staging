...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.hear_about_us'
        db.add_column(u'userprofile_userprofile', 'hear_about_us',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.hear_about_us'
        db.delete_column(u'userprofile_userprofile', 'hear_about_us')
