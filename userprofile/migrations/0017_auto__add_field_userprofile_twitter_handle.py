...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.twitter_handle'
        db.add_column(u'userprofile_userprofile', 'twitter_handle',
                      self.gf('django.db.models.fields.TextField')(default='@', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.twitter_handle'
        db.delete_column(u'userprofile_userprofile', 'twitter_handle')
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'twitter_handle': ('django.db.models.fields.TextField', [], {'default': "'@'", 'null': 'True', 'blank': 'True'}),
