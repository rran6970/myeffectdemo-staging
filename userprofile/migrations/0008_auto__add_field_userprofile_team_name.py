...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofile_userprofile', 'team_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'userprofile_userprofile', 'team_name')
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'team_name': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
