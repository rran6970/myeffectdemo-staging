...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.qr_code'
        db.add_column(u'userprofile_userprofile', 'qr_code',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['userprofile.UserQRCode'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.qr_code'
        db.delete_column(u'userprofile_userprofile', 'qr_code_id')
