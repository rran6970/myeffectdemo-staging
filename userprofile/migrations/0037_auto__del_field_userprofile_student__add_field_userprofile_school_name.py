...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.student'
        db.delete_column(u'userprofile_userprofile', 'student')

        # Adding field 'UserProfile.school_name'
        db.add_column(u'userprofile_userprofile', 'school_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.student'
        db.add_column(u'userprofile_userprofile', 'student',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.school_name'
        db.delete_column(u'userprofile_userprofile', 'school_name')
