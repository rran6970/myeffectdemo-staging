...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.emergency_phone'
        db.add_column(u'userprofile_userprofile', 'emergency_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.emergency_phone'
        db.delete_column(u'userprofile_userprofile', 'emergency_phone')
