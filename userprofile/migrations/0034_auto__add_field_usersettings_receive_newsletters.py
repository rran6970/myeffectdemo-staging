...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSettings.receive_newsletters'
        db.add_column(u'userprofile_usersettings', 'receive_newsletters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSettings.receive_newsletters'
        db.delete_column(u'userprofile_usersettings', 'receive_newsletters')
