...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserOrganization.website'
        db.add_column(u'userorganization_userorganization', 'website',
                      self.gf('django.db.models.fields.URLField')(default='http://', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserOrganization.website'
        db.delete_column(u'userorganization_userorganization', 'website')
