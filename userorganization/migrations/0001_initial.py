...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserOrganization'
        db.create_table(u'userorganization_userorganization', (
        ...
        db.send_create_signal(u'userorganization', ['UserOrganization'])


    def backwards(self, orm):
        # Deleting model 'UserOrganization'
        db.delete_table(u'userorganization_userorganization')
