...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserQuestionAnswer.challenge'
        db.add_column(u'challenges_userquestionanswer', 'challenge',
    ...
    def backwards(self, orm):
        # Deleting field 'UserQuestionAnswer.challenge'
        db.delete_column(u'challenges_userquestionanswer', 'challenge_id')
