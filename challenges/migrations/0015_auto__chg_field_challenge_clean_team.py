...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.clean_team'
        db.alter_column(u'challenges_challenge', 'clean_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], null=True))

    def backwards(self, orm):

        # Changing field 'Challenge.clean_team'
        db.alter_column(u'challenges_challenge', 'clean_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam']))
