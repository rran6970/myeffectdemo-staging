...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChallengeSkillTag'
        db.create_table(u'challenges_challengeskilltag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('challenge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'])),
            ('skill_tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.SkillTag'])),
        ))
        db.send_create_signal(u'challenges', ['ChallengeSkillTag'])

        # Adding model 'SkillTag'
        db.create_table(u'challenges_skilltag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'challenges', ['SkillTag'])


    def backwards(self, orm):
        # Deleting model 'ChallengeSkillTag'
        db.delete_table(u'challenges_challengeskilltag')

        # Deleting model 'SkillTag'
        db.delete_table(u'challenges_skilltag')
