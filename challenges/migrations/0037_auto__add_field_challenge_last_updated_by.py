...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.last_updated_by'
        db.add_column(u'challenges_challenge', 'last_updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_last_updated_by', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.last_updated_by'
        db.delete_column(u'challenges_challenge', 'last_updated_by_id')
