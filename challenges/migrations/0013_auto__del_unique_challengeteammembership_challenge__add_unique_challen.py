...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ChallengeCommunityMembership', fields ['challenge']
        db.delete_unique(u'challenges_challengecommunitymembership', ['challenge_id'])

        # Removing unique constraint on 'ChallengeTeamMembership', fields ['challenge']
        db.delete_unique(u'challenges_challengeteammembership', ['challenge_id'])

        # Adding unique constraint on 'ChallengeTeamMembership', fields ['challenge', 'clean_team']
        db.create_unique(u'challenges_challengeteammembership', ['challenge_id', 'clean_team_id'])

        # Adding unique constraint on 'ChallengeCommunityMembership', fields ['challenge', 'community']
        db.create_unique(u'challenges_challengecommunitymembership', ['challenge_id', 'community_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChallengeCommunityMembership', fields ['challenge', 'community']
        db.delete_unique(u'challenges_challengecommunitymembership', ['challenge_id', 'community_id'])

        # Removing unique constraint on 'ChallengeTeamMembership', fields ['challenge', 'clean_team']
        db.delete_unique(u'challenges_challengeteammembership', ['challenge_id', 'clean_team_id'])

        # Adding unique constraint on 'ChallengeTeamMembership', fields ['challenge']
        db.create_unique(u'challenges_challengeteammembership', ['challenge_id'])

        # Adding unique constraint on 'ChallengeCommunityMembership', fields ['challenge']
        db.create_unique(u'challenges_challengecommunitymembership', ['challenge_id'])
