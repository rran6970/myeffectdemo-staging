...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChallengeQuestion.required'
        db.add_column(u'challenges_challengequestion', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChallengeQuestion.required'
        db.delete_column(u'challenges_challengequestion', 'required')
