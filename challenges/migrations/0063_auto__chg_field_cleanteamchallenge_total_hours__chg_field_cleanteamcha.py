...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeamChallenge.total_hours'
        db.alter_column(u'challenges_cleanteamchallenge', 'total_hours', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'CleanTeamChallenge.total_clean_creds'
        db.alter_column(u'challenges_cleanteamchallenge', 'total_clean_creds', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'UserChallenge.total_hours'
        db.alter_column(u'challenges_userchallenge', 'total_hours', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'UserChallenge.total_clean_creds'
        db.alter_column(u'challenges_userchallenge', 'total_clean_creds', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'CleanTeamChallenge.total_hours'
        db.alter_column(u'challenges_cleanteamchallenge', 'total_hours', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CleanTeamChallenge.total_clean_creds'
        db.alter_column(u'challenges_cleanteamchallenge', 'total_clean_creds', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'UserChallenge.total_hours'
        db.alter_column(u'challenges_userchallenge', 'total_hours', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'UserChallenge.total_clean_creds'
        db.alter_column(u'challenges_userchallenge', 'total_clean_creds', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'challenges.cleanteamchallenge': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'total_clean_creds': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '2'}),
            'total_hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '2'})
        },
