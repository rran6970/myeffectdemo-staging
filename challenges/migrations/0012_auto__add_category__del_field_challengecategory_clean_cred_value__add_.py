...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'challenges_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='None', max_length=60)),
            ('clean_cred_value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'challenges', ['Category'])

        # Deleting field 'ChallengeCategory.clean_cred_value'
        db.delete_column(u'challenges_challengecategory', 'clean_cred_value')

        # Adding field 'ChallengeCategory.challenge'
        db.add_column(u'challenges_challengecategory', 'challenge',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['challenges.Challenge']),
                      keep_default=False)


        # Renaming column for 'ChallengeCategory.category' to match new field type.
        db.rename_column(u'challenges_challengecategory', 'category', 'category_id')
        # Changing field 'ChallengeCategory.category'
        db.alter_column(u'challenges_challengecategory', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Category']))
        # Adding index on 'ChallengeCategory', fields ['category']
        db.create_index(u'challenges_challengecategory', ['category_id'])


    def backwards(self, orm):
        # Removing index on 'ChallengeCategory', fields ['category']
        db.delete_index(u'challenges_challengecategory', ['category_id'])

        # Deleting model 'Category'
        db.delete_table(u'challenges_category')

        # Adding field 'ChallengeCategory.clean_cred_value'
        db.add_column(u'challenges_challengecategory', 'clean_cred_value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ChallengeCategory.challenge'
        db.delete_column(u'challenges_challengecategory', 'challenge_id')


        # Renaming column for 'ChallengeCategory.category' to match new field type.
        db.rename_column(u'challenges_challengecategory', 'category_id', 'category')
        # Changing field 'ChallengeCategory.category'
        db.alter_column(u'challenges_challengecategory', 'category', self.gf('django.db.models.fields.CharField')(max_length=60))
