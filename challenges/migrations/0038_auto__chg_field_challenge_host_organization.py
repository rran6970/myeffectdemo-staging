...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.host_organization'
        db.alter_column(u'challenges_challenge', 'host_organization', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Challenge.host_organization'
        db.alter_column(u'challenges_challenge', 'host_organization', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'host_organization': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
