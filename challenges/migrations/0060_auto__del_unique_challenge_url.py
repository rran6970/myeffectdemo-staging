...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Challenge', fields ['url']
        db.delete_unique(u'challenges_challenge', ['url'])


    def backwards(self, orm):
        # Adding unique constraint on 'Challenge', fields ['url']
        db.create_unique(u'challenges_challenge', ['url'])
