...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAnswer.answer_number'
        db.add_column(u'challenges_questionanswer', 'answer_number',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAnswer.answer_number'
        db.delete_column(u'challenges_questionanswer', 'answer_number')
