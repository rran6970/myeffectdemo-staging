...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChallengeQuestionType.description'
        db.alter_column(u'challenges_challengequestiontype', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ChallengeQuestionType.description'
        db.alter_column(u'challenges_challengequestiontype', 'description', self.gf('django.db.models.fields.CharField')(max_length=60))
