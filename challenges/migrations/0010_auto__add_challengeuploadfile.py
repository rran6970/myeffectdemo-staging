...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChallengeUploadFile'
        db.create_table(u'challenges_challengeuploadfile', (
        ...
        db.send_create_signal(u'challenges', ['ChallengeUploadFile'])


    def backwards(self, orm):
        # Deleting model 'ChallengeUploadFile'
        db.delete_table(u'challenges_challengeuploadfile')
