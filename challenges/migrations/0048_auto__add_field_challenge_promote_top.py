...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.promote_top'
        db.add_column(u'challenges_challenge', 'promote_top',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.promote_top'
        db.delete_column(u'challenges_challenge', 'promote_top')
