...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.event_time'
        db.delete_column(u'challenges_challenge', 'event_time')

        # Deleting field 'Challenge.event_date'
        db.delete_column(u'challenges_challenge', 'event_date')

        # Adding field 'Challenge.event_start_date'
        db.add_column(u'challenges_challenge', 'event_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.event_start_time'
        db.add_column(u'challenges_challenge', 'event_start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.event_end_date'
        db.add_column(u'challenges_challenge', 'event_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.event_end_time'
        db.add_column(u'challenges_challenge', 'event_end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Challenge.event_time'
        db.add_column(u'challenges_challenge', 'event_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Challenge.event_date'
        db.add_column(u'challenges_challenge', 'event_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Challenge.event_start_date'
        db.delete_column(u'challenges_challenge', 'event_start_date')

        # Deleting field 'Challenge.event_start_time'
        db.delete_column(u'challenges_challenge', 'event_start_time')

        # Deleting field 'Challenge.event_end_date'
        db.delete_column(u'challenges_challenge', 'event_end_date')

        # Deleting field 'Challenge.event_end_time'
        db.delete_column(u'challenges_challenge', 'event_end_time')
