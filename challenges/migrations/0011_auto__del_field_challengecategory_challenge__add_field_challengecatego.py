...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChallengeCategory.category'
        db.add_column(u'challenges_challengecategory', 'category',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ChallengeCategory.challenge'
        raise RuntimeError("Cannot reverse this migration. 'ChallengeCategory.challenge' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ChallengeCategory.challenge'
        db.add_column(u'challenges_challengecategory', 'challenge',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge']),
                      keep_default=False)

        # Deleting field 'ChallengeCategory.category'
        db.delete_column(u'challenges_challengecategory', 'category')
    ...
    models = {
        ...
        u'challenges.challengecategory': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '60'}),
