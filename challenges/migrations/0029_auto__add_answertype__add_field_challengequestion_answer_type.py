...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChallengeQuestion.answer_type'
        db.add_column(u'challenges_challengequestion', 'answer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['challenges.AnswerType'], blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ChallengeQuestion.answer_type'
        db.delete_column(u'challenges_challengequestion', 'answer_type_id')
    ...
    models = {
        ...
        u'challenges.userquestionanswer': {
