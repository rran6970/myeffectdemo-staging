...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'challenges_challenge', 'description',
                      self.gf('django.db.models.fields.TextField')(default='Description needed'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.description'
        db.delete_column(u'challenges_challenge', 'description')
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "'Description needed'"}),
