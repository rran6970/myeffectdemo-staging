...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionAnswer.question_number'
        db.delete_column(u'challenges_questionanswer', 'question_number')


    def backwards(self, orm):
        # Adding field 'QuestionAnswer.question_number'
        db.add_column(u'challenges_questionanswer', 'question_number',
