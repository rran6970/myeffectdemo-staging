...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.event_datetime'
        db.alter_column(u'challenges_challenge', 'event_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'Challenge.event_datetime'
        db.alter_column(u'challenges_challenge', 'event_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 22, 0, 0)))
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'event_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
