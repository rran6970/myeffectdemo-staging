...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChallengeParticipant.start_date'
        db.add_column(u'challenges_challengeparticipant', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChallengeParticipant.end_date'
        db.add_column(u'challenges_challengeparticipant', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChallengeParticipant.start_date'
        db.delete_column(u'challenges_challengeparticipant', 'start_date')

        # Deleting field 'ChallengeParticipant.end_date'
        db.delete_column(u'challenges_challengeparticipant', 'end_date')
