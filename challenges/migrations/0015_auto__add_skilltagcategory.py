...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SkillTagCategory'
        db.create_table(u'challenges_skilltagcategory', (
        ...
        db.send_create_signal(u'challenges', ['SkillTagCategory'])


    def backwards(self, orm):
        # Deleting model 'SkillTagCategory'
        db.delete_table(u'challenges_skilltagcategory')
