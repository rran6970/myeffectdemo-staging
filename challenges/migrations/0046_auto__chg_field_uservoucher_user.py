...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserVoucher.user'
        db.alter_column(u'challenges_uservoucher', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'UserVoucher.user'
        db.alter_column(u'challenges_uservoucher', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
    ...
    models = {
        ...
        u'challenges.uservoucher': {
            ...
            'voucher': ('django.db.models.fields.CharField', [], {'max_length': '60'})
        },
