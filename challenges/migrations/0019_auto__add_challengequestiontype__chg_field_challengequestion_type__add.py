...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'challenges_challengequestiontype', (
            ...
            ('description', self.gf('django.db.models.fields.CharField')(default='None', max_length=60)),
        ))
        db.send_create_signal(u'challenges', ['ChallengeQuestionType'])


        # Renaming column for 'ChallengeQuestion.type' to match new field type.
        db.rename_column(u'challenges_challengequestion', 'type', 'type_id')
        # Changing field 'ChallengeQuestion.type'
        db.alter_column(u'challenges_challengequestion', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.ChallengeQuestionType']))
        # Adding index on 'ChallengeQuestion', fields ['type']
        db.create_index(u'challenges_challengequestion', ['type_id'])


    def backwards(self, orm):
        # Removing index on 'ChallengeQuestion', fields ['type']
        db.delete_index(u'challenges_challengequestion', ['type_id'])
        ...
        # Renaming column for 'ChallengeQuestion.type' to match new field type.
        db.rename_column(u'challenges_challengequestion', 'type_id', 'type')
        # Changing field 'ChallengeQuestion.type'
        db.alter_column(u'challenges_challengequestion', 'type', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    models = {
        ...
        u'challenges.challengequestiontype': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '60'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '60'})
        },
