...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ChallengeQRCode.data'
        db.alter_column(u'challenges_challengeqrcode', 'data', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['challenges.ChallengeType']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'challenges.challengeqrcode': {
            'Meta': {'object_name': 'ChallengeQRCode'},
            'data': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
