...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionAnswer.score'
        db.alter_column(u'challenges_questionanswer', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'QuestionAnswer.score'
        db.alter_column(u'challenges_questionanswer', 'score', self.gf('django.db.models.fields.IntegerField')(default=0))
