...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionAnswer.clean_grid'
        db.alter_column(u'challenges_questionanswer', 'clean_grid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.CleanGrid'], null=True))

    def backwards(self, orm):

        # Changing field 'QuestionAnswer.clean_grid'
        db.alter_column(u'challenges_questionanswer', 'clean_grid_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['challenges.CleanGrid']))
    ...
    models = {
        ...
        u'challenges.questionanswer': {
            ...
            'clean_grid': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['challenges.CleanGrid']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
