...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserChallenge.total_clean_creds'
        db.add_column(u'challenges_userchallenge', 'total_clean_creds',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserChallenge.total_clean_creds'
        db.delete_column(u'challenges_userchallenge', 'total_clean_creds')
