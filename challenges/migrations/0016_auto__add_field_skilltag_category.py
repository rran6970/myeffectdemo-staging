...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkillTag.category'
        db.add_column(u'challenges_skilltag', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['challenges.SkillTagCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkillTag.category'
        db.delete_column(u'challenges_skilltag', 'category_id')
