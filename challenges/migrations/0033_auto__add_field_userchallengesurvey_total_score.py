...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserChallengeSurvey.total_score'
        db.add_column(u'challenges_userchallengesurvey', 'total_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserChallengeSurvey.total_score'
        db.delete_column(u'challenges_userchallengesurvey', 'total_score')
