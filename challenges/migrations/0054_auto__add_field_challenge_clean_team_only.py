...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.clean_team_only'
        db.add_column(u'challenges_challenge', 'clean_team_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.clean_team_only'
        db.delete_column(u'challenges_challenge', 'clean_team_only')
