...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.day_of_week'
        db.add_column(u'challenges_challenge', 'day_of_week',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.day_of_week'
        db.delete_column(u'challenges_challenge', 'day_of_week')
