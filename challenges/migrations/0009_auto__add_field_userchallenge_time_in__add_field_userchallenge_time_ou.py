...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserChallenge.time_in'
        db.add_column(u'challenges_userchallenge', 'time_in',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserChallenge.time_out'
        db.add_column(u'challenges_userchallenge', 'time_out',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserChallenge.total_hours'
        db.add_column(u'challenges_userchallenge', 'total_hours',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserChallenge.time_in'
        db.delete_column(u'challenges_userchallenge', 'time_in')

        # Deleting field 'UserChallenge.time_out'
        db.delete_column(u'challenges_userchallenge', 'time_out')

        # Deleting field 'UserChallenge.total_hours'
        db.delete_column(u'challenges_userchallenge', 'total_hours')
