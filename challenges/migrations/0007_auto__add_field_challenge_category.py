...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.category'
        db.add_column(u'challenges_challenge', 'category',
                      self.gf('django.db.models.fields.CharField')(default='General', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.category'
        db.delete_column(u'challenges_challenge', 'category')
