...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.clean_team'
        db.add_column(u'challenges_challenge', 'clean_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['cleanteams.CleanTeam']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.clean_team'
        db.delete_column(u'challenges_challenge', 'clean_team_id')
