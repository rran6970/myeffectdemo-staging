...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.link'
        db.add_column(u'challenges_challenge', 'link',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.link'
        db.delete_column(u'challenges_challenge', 'link')
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'link': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
