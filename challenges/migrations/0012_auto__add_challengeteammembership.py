...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChallengeTeamMembership'
        db.create_table(u'challenges_challengeteammembership', (
        ...
        db.send_create_signal(u'challenges', ['ChallengeTeamMembership'])


    def backwards(self, orm):
        # Deleting model 'ChallengeTeamMembership'
        db.delete_table(u'challenges_challengeteammembership')
    ...
    models = {
        ...
        u'challenges.challengeteammembership': {
            'Meta': {'object_name': 'ChallengeTeamMembership'},
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['challenges.Challenge']", 'unique': 'True'}),
