...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Challenge.qr_code'
        db.add_column(u'challenges_challenge', 'qr_code',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['challenges.ChallengeQRCode'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Challenge.qr_code'
        db.delete_column(u'challenges_challenge', 'qr_code_id')
