...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Challenge.type'
        db.add_column(u'challenges_challenge', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['challenges.ChallengeType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Challenge.type'
        db.delete_column(u'challenges_challenge', 'type_id')
