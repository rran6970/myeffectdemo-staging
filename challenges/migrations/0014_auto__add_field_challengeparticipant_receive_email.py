...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChallengeParticipant.receive_email'
        db.add_column(u'challenges_challengeparticipant', 'receive_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChallengeParticipant.receive_email'
        db.delete_column(u'challenges_challengeparticipant', 'receive_email')
