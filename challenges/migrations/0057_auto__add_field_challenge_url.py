...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.url'
        db.add_column(u'challenges_challenge', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.url'
        db.delete_column(u'challenges_challenge', 'url')
    ...
    models = {
        ...
        u'challenges.stapleschallenge': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stapes_store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['challenges.StaplesStores']", 'null': 'True', 'blank': 'True'})
        },
