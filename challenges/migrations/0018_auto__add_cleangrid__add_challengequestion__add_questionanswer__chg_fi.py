...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'challenges_challengequestion', (
            ...
            ('question', self.gf('django.db.models.fields.CharField')(default='None', max_length=60)),
            ('type', self.gf('django.db.models.fields.CharField')(default='None', max_length=60)),
        ))
        ...
        db.create_table(u'challenges_questionanswer', (
            ...
            ('clean_grid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.CleanGrid'], blank=True)),
        ))
        db.send_create_signal(u'challenges', ['QuestionAnswer'])


        # Changing field 'UserChallenge.time_in'
        db.alter_column(u'challenges_userchallenge', 'time_in', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'UserChallenge.time_out'
        db.alter_column(u'challenges_userchallenge', 'time_out', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'Challenge.host_organization'
        db.add_column(u'challenges_challenge', 'host_organization',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserChallenge.time_in'
        db.alter_column(u'challenges_userchallenge', 'time_in', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'UserChallenge.time_out'
        db.alter_column(u'challenges_userchallenge', 'time_out', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Deleting field 'Challenge.host_organization'
        db.delete_column(u'challenges_challenge', 'host_organization')
    ...
    models = {
        ...
        u'challenges.challengequestion': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '60'}),
            'question_number': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '60'})
        },
