...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserChallengeSurvey.category'
        db.add_column(u'challenges_userchallengesurvey', 'category',
                      self.gf('django.db.models.fields.CharField')(default='General', max_length=60),
                      keep_default=False)

        # Adding field 'UserChallengeSurveyAnswers.answerdetail'
        db.add_column(u'challenges_userchallengesurveyanswers', 'answerdetail',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserChallengeSurveyAnswers.answer'
        db.alter_column(u'challenges_userchallengesurveyanswers', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.QuestionAnswer'], null=True))

    def backwards(self, orm):
        # Deleting field 'UserChallengeSurvey.category'
        db.delete_column(u'challenges_userchallengesurvey', 'category')

        # Deleting field 'UserChallengeSurveyAnswers.answerdetail'
        db.delete_column(u'challenges_userchallengesurveyanswers', 'answerdetail')


        # Changing field 'UserChallengeSurveyAnswers.answer'
        db.alter_column(u'challenges_userchallengesurveyanswers', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['challenges.QuestionAnswer']))
