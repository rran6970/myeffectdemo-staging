...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ChallengeCategory'
        db.delete_table(u'challenges_challengecategory')

        # Deleting model 'Category'
        db.delete_table(u'challenges_category')

        # Adding field 'Challenge.total_score'
        db.add_column(u'challenges_challenge', 'total_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'ChallengeCategory'
        db.create_table(u'challenges_challengecategory', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Category'])),
            ('challenge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'challenges', ['ChallengeCategory'])
        ...
        # Deleting field 'Challenge.total_score'
        db.delete_column(u'challenges_challenge', 'total_score')
