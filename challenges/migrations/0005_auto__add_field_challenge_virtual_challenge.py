...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.virtual_challenge'
        db.add_column(u'challenges_challenge', 'virtual_challenge',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.virtual_challenge'
        db.delete_column(u'challenges_challenge', 'virtual_challenge')
