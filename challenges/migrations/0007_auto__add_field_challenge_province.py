...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.province'
        db.add_column(u'challenges_challenge', 'province',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.province'
        db.delete_column(u'challenges_challenge', 'province')
