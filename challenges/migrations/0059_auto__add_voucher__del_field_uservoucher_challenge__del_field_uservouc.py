...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserVoucher', fields ['voucher']
        # db.delete_unique(u'challenges_uservoucher', ['voucher'])
        ...
        # Deleting field 'UserVoucher.challenge'
        db.delete_column(u'challenges_uservoucher', 'challenge_id')

        # Deleting field 'UserVoucher.clean_creds'
        db.delete_column(u'challenges_uservoucher', 'clean_creds')

        # Adding field 'UserVoucher.timestamp'
        db.add_column(u'challenges_uservoucher', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'UserVoucher.voucher' to match new field type.
        db.rename_column(u'challenges_uservoucher', 'voucher', 'voucher_id')
        # Changing field 'UserVoucher.voucher'
        db.alter_column(u'challenges_uservoucher', 'voucher_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Voucher'], null=True))
        # Adding index on 'UserVoucher', fields ['voucher']
        db.create_index(u'challenges_uservoucher', ['voucher_id'])


    def backwards(self, orm):
        # Removing index on 'UserVoucher', fields ['voucher']
        db.delete_index(u'challenges_uservoucher', ['voucher_id'])

        # Deleting model 'Voucher'
        db.delete_table(u'challenges_voucher')

        # Adding field 'UserVoucher.challenge'
        db.add_column(u'challenges_uservoucher', 'challenge',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserVoucher.clean_creds'
        db.add_column(u'challenges_uservoucher', 'clean_creds',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UserVoucher.timestamp'
        db.delete_column(u'challenges_uservoucher', 'timestamp')


        # Renaming column for 'UserVoucher.voucher' to match new field type.
        db.rename_column(u'challenges_uservoucher', 'voucher_id', 'voucher')
        # Changing field 'UserVoucher.voucher'
        db.alter_column(u'challenges_uservoucher', 'voucher', self.gf('django.db.models.fields.CharField')(default=1, max_length=60, unique=True))
        # Adding unique constraint on 'UserVoucher', fields ['voucher']
        db.create_unique(u'challenges_uservoucher', ['voucher'])
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'max_length': '60', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
