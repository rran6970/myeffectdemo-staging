...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ChallengeQuestionType', fields ['name']
        db.create_unique(u'challenges_challengequestiontype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChallengeQuestionType', fields ['name']
        db.delete_unique(u'challenges_challengequestiontype', ['name'])
