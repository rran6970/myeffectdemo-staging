...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StaplesChallenge.stapes_store'
        db.delete_column(u'challenges_stapleschallenge', 'stapes_store_id')

        # Adding field 'StaplesChallenge.staples_store'
        db.add_column(u'challenges_stapleschallenge', 'staples_store',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.StaplesStores'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StaplesChallenge.stapes_store'
        db.add_column(u'challenges_stapleschallenge', 'stapes_store',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.StaplesStores'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'StaplesChallenge.staples_store'
        db.delete_column(u'challenges_stapleschallenge', 'staples_store_id')
