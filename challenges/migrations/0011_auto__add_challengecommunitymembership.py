...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'challenges_challengecommunitymembership', (
        ...
        db.send_create_signal(u'challenges', ['ChallengeCommunityMembership'])


    def backwards(self, orm):
        # Deleting model 'ChallengeCommunityMembership'
        db.delete_table(u'challenges_challengecommunitymembership')
