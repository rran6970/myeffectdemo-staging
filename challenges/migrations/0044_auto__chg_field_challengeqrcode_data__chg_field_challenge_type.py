...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChallengeQRCode.data'
        db.alter_column(u'challenges_challengeqrcode', 'data', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Challenge.type'
        db.alter_column(u'challenges_challenge', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.ChallengeType'], null=True))

    def backwards(self, orm):

        # Changing field 'ChallengeQRCode.data'
        db.alter_column(u'challenges_challengeqrcode', 'data', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Challenge.type'
        db.alter_column(u'challenges_challenge', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.ChallengeType']))
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'qr_code': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['challenges.ChallengeQRCode']", 'unique': 'True', 'null': 'True'}),
