...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'challenges_cleanteamchallenge', 'total_hours', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))

        # Changing field 'CleanTeamChallenge.total_clean_creds'
        db.alter_column(u'challenges_cleanteamchallenge', 'total_clean_creds', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))

        # Changing field 'UserChallenge.total_hours'
        db.alter_column(u'challenges_userchallenge', 'total_hours', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))

        # Changing field 'UserChallenge.total_clean_creds'
        db.alter_column(u'challenges_userchallenge', 'total_clean_creds', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))
