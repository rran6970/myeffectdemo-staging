...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Challenge.clean_creds_per_hour'
        db.add_column(u'challenges_challenge', 'clean_creds_per_hour',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Challenge.clean_creds_per_hour'
        db.delete_column(u'challenges_challenge', 'clean_creds_per_hour')
