...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserChallengeSurvey.challenge'
        db.alter_column(u'challenges_userchallengesurvey', 'challenge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'], null=True))

    def backwards(self, orm):

        # Changing field 'UserChallengeSurvey.challenge'
        db.alter_column(u'challenges_userchallengesurvey', 'challenge_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['challenges.Challenge']))
