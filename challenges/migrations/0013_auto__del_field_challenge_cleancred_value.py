...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.cleancred_value'
        db.delete_column(u'challenges_challenge', 'cleancred_value')


    def backwards(self, orm):
        # Adding field 'Challenge.cleancred_value'
        db.add_column(u'challenges_challenge', 'cleancred_value',
