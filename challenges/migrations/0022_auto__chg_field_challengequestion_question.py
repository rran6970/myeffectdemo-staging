...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ChallengeQuestion.question'
        db.alter_column(u'challenges_challengequestion', 'question', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    models = {
        ...
        u'challenges.challengequestion': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '100'}),
