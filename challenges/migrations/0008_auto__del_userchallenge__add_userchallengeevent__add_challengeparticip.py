...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserChallengeEvent'
        db.create_table(u'challenges_userchallengeevent', (
        ...
        db.send_create_signal(u'challenges', ['UserChallengeEvent'])

        # Adding model 'ChallengeParticipant'
        db.create_table(u'challenges_challengeparticipant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('challenge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ...
        db.send_create_signal(u'challenges', ['ChallengeParticipant'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserChallengeEvent'
        db.delete_table(u'challenges_userchallengeevent')

        # Deleting model 'ChallengeParticipant'
        db.delete_table(u'challenges_challengeparticipant')
