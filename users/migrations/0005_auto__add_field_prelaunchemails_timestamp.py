...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrelaunchEmails.timestamp'
        db.add_column(u'users_prelaunchemails', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrelaunchEmails.timestamp'
        db.delete_column(u'users_prelaunchemails', 'timestamp')
