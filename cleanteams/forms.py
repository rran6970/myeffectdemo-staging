...
class RegisterCleanTeamForm(forms.ModelForm):
    ...
    bio = forms.CharField(required=False, min_length = 2, widget=forms.Textarea())
    ...
    def clean(self):
        ...
        if not name:
            ...
            raise forms.ValidationError("Please enter the change team bio")
