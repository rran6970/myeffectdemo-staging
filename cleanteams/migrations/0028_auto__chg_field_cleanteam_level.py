...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeam.level'
        db.alter_column(u'cleanteams_cleanteam', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeamLevel'], null=True))

    def backwards(self, orm):

        # Changing field 'CleanTeam.level'
        db.alter_column(u'cleanteams_cleanteam', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeamLevel']))
