...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeam.level'
        db.add_column(u'cleanteams_cleanteam', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cleanteams.CleanTeamLevel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeam.level'
        db.delete_column(u'cleanteams_cleanteam', 'level_id')
    ...
    models = {
        ...
        u'cleanteams.cleanteamlevel': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.CharField', [], {'default': "'Seedling'", 'max_length': '30'})
        },
