...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeamFollow.clean_team'
        db.alter_column(u'cleanteams_cleanteamfollow', 'clean_team_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cleanteams.CleanTeam']))

        # Changing field 'CleanTeamFollow.user'
        db.alter_column(u'cleanteams_cleanteamfollow', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'CleanTeamFollow.clean_team'
        db.alter_column(u'cleanteams_cleanteamfollow', 'clean_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], null=True))

        # Changing field 'CleanTeamFollow.user'
        db.alter_column(u'cleanteams_cleanteamfollow', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
