...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeamMember.status'
        db.alter_column(u'cleanteams_cleanteammember', 'status', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'CleanTeamMember.status'
        db.alter_column(u'cleanteams_cleanteammember', 'status', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'cleanteams.cleanteammember': {
            ...
            'cleam_team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.CleanTeam']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
