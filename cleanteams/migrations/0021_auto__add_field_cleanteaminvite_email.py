...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamInvite.email'
        db.add_column(u'cleanteams_cleanteaminvite', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=70, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamInvite.email'
        db.delete_column(u'cleanteams_cleanteaminvite', 'email')
