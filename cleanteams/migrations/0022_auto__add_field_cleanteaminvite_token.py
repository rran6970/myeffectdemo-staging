...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamInvite.token'
        db.add_column(u'cleanteams_cleanteaminvite', 'token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamInvite.token'
        db.delete_column(u'cleanteams_cleanteaminvite', 'token')
    ...
    models = {
        ...
        u'cleanteams.cleanteaminvite': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
