...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamLevelTask.link'
        db.add_column(u'cleanteams_cleanteamleveltask', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamLevelTask.link'
        db.delete_column(u'cleanteams_cleanteamleveltask', 'link')
