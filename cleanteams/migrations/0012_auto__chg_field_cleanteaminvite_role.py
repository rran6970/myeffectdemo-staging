...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeamInvite.role'
        db.alter_column(u'cleanteams_cleanteaminvite', 'role', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'CleanTeamInvite.role'
        db.alter_column(u'cleanteams_cleanteaminvite', 'role', self.gf('django.db.models.fields.CharField')(max_length=30))
