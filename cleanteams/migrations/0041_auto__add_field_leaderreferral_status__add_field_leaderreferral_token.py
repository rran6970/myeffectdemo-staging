...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeaderReferral.status'
        db.add_column(u'cleanteams_leaderreferral', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=30),
                      keep_default=False)

        # Adding field 'LeaderReferral.token'
        db.add_column(u'cleanteams_leaderreferral', 'token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeaderReferral.status'
        db.delete_column(u'cleanteams_leaderreferral', 'status')

        # Deleting field 'LeaderReferral.token'
        db.delete_column(u'cleanteams_leaderreferral', 'token')
