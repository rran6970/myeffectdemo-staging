...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Invite'
        db.create_table(u'cleanteams_invite', (
        ...
        db.send_create_signal(u'cleanteams', ['Invite'])

        # Adding field 'CleanChampion.data_privacy'
        db.add_column(u'cleanteams_cleanchampion', 'data_privacy',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cleanteams_invite')

        # Deleting field 'CleanChampion.data_privacy'
        db.delete_column(u'cleanteams_cleanchampion', 'data_privacy')
    ...
    models = {
        ...
        u'cleanteams.teamantispam': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'signature': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
