...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CleanTeamLevel.level'
        db.delete_column(u'cleanteams_cleanteamlevel', 'level')

        # Adding field 'CleanTeamLevel.name'
        db.add_column(u'cleanteams_cleanteamlevel', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Seedling', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CleanTeamLevel.level'
        db.add_column(u'cleanteams_cleanteamlevel', 'level',
                      self.gf('django.db.models.fields.CharField')(default='Seedling', max_length=30),
                      keep_default=False)

        # Deleting field 'CleanTeamLevel.name'
        db.delete_column(u'cleanteams_cleanteamlevel', 'name')
    ...
    models = {
        ...
        u'cleanteams.cleanteam': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['cleanteams.CleanTeamLevel']"}),
