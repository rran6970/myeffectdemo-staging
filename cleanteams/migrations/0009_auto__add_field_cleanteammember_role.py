...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamMember.role'
        db.add_column(u'cleanteams_cleanteammember', 'role',
                      self.gf('django.db.models.fields.CharField')(default='clean-ambassador', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamMember.role'
        db.delete_column(u'cleanteams_cleanteammember', 'role')
