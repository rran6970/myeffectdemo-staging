...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CleanTeamLevelTask', fields ['name']
        db.create_unique(u'cleanteams_cleanteamleveltask', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'CleanTeamLevelTask', fields ['name']
        db.delete_unique(u'cleanteams_cleanteamleveltask', ['name'])
