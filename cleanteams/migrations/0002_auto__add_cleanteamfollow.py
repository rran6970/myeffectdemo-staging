...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CleanTeamFollow'
        db.create_table(u'cleanteams_cleanteamfollow', (
        ...
        db.send_create_signal(u'cleanteams', ['CleanTeamFollow'])


    def backwards(self, orm):
        # Deleting model 'CleanTeamFollow'
        db.delete_table(u'cleanteams_cleanteamfollow')
