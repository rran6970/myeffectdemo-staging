...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeamAntiSpam'
        db.create_table(u'cleanteams_teamantispam', (
            ...
            ('group_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'cleanteams', ['TeamAntiSpam'])


    def backwards(self, orm):
        # Deleting model 'TeamAntiSpam'
        db.delete_table(u'cleanteams_teamantispam')
    ...
    models = {
        ...
        u'cleanteams.teamantispam': {
            'Meta': {'object_name': 'TeamAntiSpam'},
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'group_name': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
