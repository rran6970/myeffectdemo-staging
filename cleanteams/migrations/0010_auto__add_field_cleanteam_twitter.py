...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeam.twitter'
        db.add_column(u'cleanteams_cleanteam', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='@', max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeam.twitter'
        db.delete_column(u'cleanteams_cleanteam', 'twitter')
    ...
    models = {
        ...
        u'cleanteams.cleanteam': {
            ...
            'twitter': ('django.db.models.fields.CharField', [], {'default': "'@'", 'max_length': '60', 'null': 'True', 'blank': 'True'}),
