...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamLevel.tree_level'
        db.add_column(u'cleanteams_cleanteamlevel', 'tree_level',
                      self.gf('django.db.models.fields.CharField')(default='images/clean-team-tree-stage-1.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamLevel.tree_level'
        db.delete_column(u'cleanteams_cleanteamlevel', 'tree_level')
