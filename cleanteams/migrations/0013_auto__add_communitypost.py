...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommunityPost'
        db.create_table(u'cleanteams_communitypost', (
        ...
        db.send_create_signal(u'cleanteams', ['CommunityPost'])


    def backwards(self, orm):
        # Deleting model 'CommunityPost'
        db.delete_table(u'cleanteams_communitypost')
