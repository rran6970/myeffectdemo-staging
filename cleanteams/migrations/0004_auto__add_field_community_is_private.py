...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.is_private'
        db.add_column(u'cleanteams_community', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.is_private'
        db.delete_column(u'cleanteams_community', 'is_private')
