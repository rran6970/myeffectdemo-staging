...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeamCommunityMembershipRequest'
        db.create_table(u'cleanteams_teamcommunitymembershiprequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clean_team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], unique=True)),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.Community'])),
        ))
        db.send_create_signal(u'cleanteams', ['TeamCommunityMembershipRequest'])

        # Adding model 'UserCommunityMembershipRequest'
        db.create_table(u'cleanteams_usercommunitymembershiprequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.Community'])),
        ))
        db.send_create_signal(u'cleanteams', ['UserCommunityMembershipRequest'])


    def backwards(self, orm):
        # Deleting model 'TeamCommunityMembershipRequest'
        db.delete_table(u'cleanteams_teamcommunitymembershiprequest')

        # Deleting model 'UserCommunityMembershipRequest'
        db.delete_table(u'cleanteams_usercommunitymembershiprequest')
