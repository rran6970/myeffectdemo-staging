...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserCommunityMembership', fields ['user']
        db.create_unique(u'cleanteams_usercommunitymembership', ['user_id'])

        # Adding unique constraint on 'TeamCommunityMembership', fields ['clean_team']
        db.create_unique(u'cleanteams_teamcommunitymembership', ['clean_team_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TeamCommunityMembership', fields ['clean_team']
        db.delete_unique(u'cleanteams_teamcommunitymembership', ['clean_team_id'])

        # Removing unique constraint on 'UserCommunityMembership', fields ['user']
        db.delete_unique(u'cleanteams_usercommunitymembership', ['user_id'])
