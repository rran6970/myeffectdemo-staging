...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamLevelTask.name'
        db.add_column(u'cleanteams_cleanteamleveltask', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamLevelTask.name'
        db.delete_column(u'cleanteams_cleanteamleveltask', 'name')
