...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Community', fields ['name']
        db.delete_unique(u'cleanteams_community', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Community', fields ['name']
        db.create_unique(u'cleanteams_community', ['name'])
