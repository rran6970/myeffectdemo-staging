...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeamInvite.clean_team'
        db.alter_column(u'cleanteams_cleanteaminvite', 'clean_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CleanTeamInvite.clean_team'
        raise RuntimeError("Cannot reverse this migration. 'CleanTeamInvite.clean_team' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CleanTeamInvite.clean_team'
        db.alter_column(u'cleanteams_cleanteaminvite', 'clean_team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam']))
