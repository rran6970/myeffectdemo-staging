...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.owner_user'
        db.add_column(u'cleanteams_community', 'owner_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.owner_user'
        db.delete_column(u'cleanteams_community', 'owner_user_id')
    ...
    models = {
        ...
        u'cleanteams.community': {
            ...
            'owner_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
