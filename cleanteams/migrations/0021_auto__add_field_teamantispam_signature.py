...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamAntiSpam.signature'
        db.add_column(u'cleanteams_teamantispam', 'signature',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamAntiSpam.signature'
        db.delete_column(u'cleanteams_teamantispam', 'signature')
