...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cleanteams_community', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=120)),
        ))
        db.send_create_signal(u'cleanteams', ['Community'])


    def backwards(self, orm):
        # Deleting model 'Community'
        db.delete_table(u'cleanteams_community')
