...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamLevelProgress.approval_requested'
        db.add_column(u'cleanteams_cleanteamlevelprogress', 'approval_requested',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CleanTeamLevelTask.approval_required'
        db.add_column(u'cleanteams_cleanteamleveltask', 'approval_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamLevelProgress.approval_requested'
        db.delete_column(u'cleanteams_cleanteamlevelprogress', 'approval_requested')

        # Deleting field 'CleanTeamLevelTask.approval_required'
        db.delete_column(u'cleanteams_cleanteamleveltask', 'approval_required')
