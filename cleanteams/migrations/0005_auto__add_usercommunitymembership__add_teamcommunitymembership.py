...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserCommunityMembership'
        db.create_table(u'cleanteams_usercommunitymembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.Community'])),
        ))
        db.send_create_signal(u'cleanteams', ['UserCommunityMembership'])

        # Adding model 'TeamCommunityMembership'
        db.create_table(u'cleanteams_teamcommunitymembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clean_team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'])),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.Community'])),
        ))
        db.send_create_signal(u'cleanteams', ['TeamCommunityMembership'])


    def backwards(self, orm):
        # Deleting model 'UserCommunityMembership'
        db.delete_table(u'cleanteams_usercommunitymembership')

        # Deleting model 'TeamCommunityMembership'
        db.delete_table(u'cleanteams_teamcommunitymembership')
