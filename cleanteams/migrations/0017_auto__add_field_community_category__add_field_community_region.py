...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.category'
        db.add_column(u'cleanteams_community', 'category',
                      self.gf('django.db.models.fields.CharField')(default='General', max_length=60),
                      keep_default=False)

        # Adding field 'Community.region'
        db.add_column(u'cleanteams_community', 'region',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.category'
        db.delete_column(u'cleanteams_community', 'category')

        # Deleting field 'Community.region'
        db.delete_column(u'cleanteams_community', 'region')
