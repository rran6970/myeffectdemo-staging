...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamInvite.community'
        db.add_column(u'cleanteams_cleanteaminvite', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.Community'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamInvite.community'
        db.delete_column(u'cleanteams_cleanteaminvite', 'community_id')
