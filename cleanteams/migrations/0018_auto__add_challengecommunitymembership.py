...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChallengeCommunityMembership'
        db.create_table(u'cleanteams_challengecommunitymembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('challenge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge'], unique=True)),
        ...
        db.send_create_signal(u'cleanteams', ['ChallengeCommunityMembership'])


    def backwards(self, orm):
        # Deleting model 'ChallengeCommunityMembership'
        db.delete_table(u'cleanteams_challengecommunitymembership')
    ...
    models = {
        ...
        u'cleanteams.challengecommunitymembership': {
            'Meta': {'object_name': 'ChallengeCommunityMembership'},
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['challenges.Challenge']", 'unique': 'True'}),
