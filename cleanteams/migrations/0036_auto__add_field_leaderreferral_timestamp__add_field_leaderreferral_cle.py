...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeaderReferral.timestamp'
        db.add_column(u'cleanteams_leaderreferral', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaderReferral.clean_team'
        db.add_column(u'cleanteams_leaderreferral', 'clean_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeam'], null=True),
                      keep_default=False)

        # Adding field 'LeaderReferral.user'
        db.add_column(u'cleanteams_leaderreferral', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeaderReferral.timestamp'
        db.delete_column(u'cleanteams_leaderreferral', 'timestamp')

        # Deleting field 'LeaderReferral.clean_team'
        db.delete_column(u'cleanteams_leaderreferral', 'clean_team_id')

        # Deleting field 'LeaderReferral.user'
        db.delete_column(u'cleanteams_leaderreferral', 'user_id')
