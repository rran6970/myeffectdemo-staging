...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeam.contact_user'
        db.add_column(u'cleanteams_cleanteam', 'contact_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'CleanTeam.contact_phone'
        db.add_column(u'cleanteams_cleanteam', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeam.contact_user'
        db.delete_column(u'cleanteams_cleanteam', 'contact_user_id')

        # Deleting field 'CleanTeam.contact_phone'
        db.delete_column(u'cleanteams_cleanteam', 'contact_phone')
