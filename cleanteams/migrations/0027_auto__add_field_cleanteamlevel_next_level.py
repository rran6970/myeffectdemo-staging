...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeamLevel.next_level'
        db.add_column(u'cleanteams_cleanteamlevel', 'next_level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cleanteams.CleanTeamLevel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeamLevel.next_level'
        db.delete_column(u'cleanteams_cleanteamlevel', 'next_level_id')
