...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.website'
        db.add_column(u'cleanteams_community', 'website',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.logo'
        db.add_column(u'cleanteams_community', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.about'
        db.add_column(u'cleanteams_community', 'about',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.twitter'
        db.add_column(u'cleanteams_community', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.facebook'
        db.add_column(u'cleanteams_community', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.instagram'
        db.add_column(u'cleanteams_community', 'instagram',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.clean_creds'
        db.add_column(u'cleanteams_community', 'clean_creds',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Community.contact_user'
        db.add_column(u'cleanteams_community', 'contact_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='contact_user', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Community.contact_phone'
        db.add_column(u'cleanteams_community', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.website'
        db.delete_column(u'cleanteams_community', 'website')

        # Deleting field 'Community.logo'
        db.delete_column(u'cleanteams_community', 'logo')

        # Deleting field 'Community.about'
        db.delete_column(u'cleanteams_community', 'about')

        # Deleting field 'Community.twitter'
        db.delete_column(u'cleanteams_community', 'twitter')

        # Deleting field 'Community.facebook'
        db.delete_column(u'cleanteams_community', 'facebook')

        # Deleting field 'Community.instagram'
        db.delete_column(u'cleanteams_community', 'instagram')

        # Deleting field 'Community.clean_creds'
        db.delete_column(u'cleanteams_community', 'clean_creds')

        # Deleting field 'Community.contact_user'
        db.delete_column(u'cleanteams_community', 'contact_user_id')

        # Deleting field 'Community.contact_phone'
        db.delete_column(u'cleanteams_community', 'contact_phone')
    ...
    models = {
        ...
        u'cleanteams.cleanteaminvite': {
            ...
            'community': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.Community']", 'null': 'True', 'blank': 'True'}),
        ...
        u'cleanteams.communitypost': {
            'Meta': {'object_name': 'CommunityPost'},
        ...
        u'cleanteams.teamcommunitymembership': {
            ...
            'clean_team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.CleanTeam']", 'unique': 'True'}),
            'community': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.Community']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'cleanteams.teamcommunitymembershiprequest': {
            'Meta': {'object_name': 'TeamCommunityMembershipRequest'},
            'clean_team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.CleanTeam']", 'unique': 'True'}),
            'community': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.Community']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'cleanteams.usercommunitymembershiprequest': {
            'Meta': {'object_name': 'UserCommunityMembershipRequest'},
            'community': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.Community']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
