...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CleanTeam.region'
        db.add_column(u'cleanteams_cleanteam', 'region',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CleanTeam.team_type'
        db.add_column(u'cleanteams_cleanteam', 'team_type',
                      self.gf('django.db.models.fields.CharField')(default='individual', max_length=60),
                      keep_default=False)

        # Adding field 'CleanTeam.group'
        db.add_column(u'cleanteams_cleanteam', 'group',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CleanTeam.region'
        db.delete_column(u'cleanteams_cleanteam', 'region')

        # Deleting field 'CleanTeam.team_type'
        db.delete_column(u'cleanteams_cleanteam', 'team_type')

        # Deleting field 'CleanTeam.group'
        db.delete_column(u'cleanteams_cleanteam', 'group')
    ...
    models = {
        ...
        u'cleanteams.cleanteam': {
            ...
            'team_type': ('django.db.models.fields.CharField', [], {'default': "'individual'", 'max_length': '60'}),
