...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CleanTeamInvite.token'
        db.alter_column(u'cleanteams_cleanteaminvite', 'token', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'LeaderReferral.token'
        db.alter_column(u'cleanteams_leaderreferral', 'token', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'CleanTeamInvite.token'
        db.alter_column(u'cleanteams_cleanteaminvite', 'token', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'LeaderReferral.token'
        db.alter_column(u'cleanteams_leaderreferral', 'token', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'cleanteams.cleanteammember': {
            ...
            'clean_team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cleanteams.CleanTeam']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.CharField', [], {'default': "'ambassador'", 'max_length': '30'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'pending'", 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
